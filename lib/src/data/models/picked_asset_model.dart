...
class PickedAssetModel {
  ...
  factory PickedAssetModel.fromJson(Map<String, dynamic> json) => PickedAssetModel(
    id: json["id"],
    path: json["path"],
    type: json["type"],
  ...
  Map<String, dynamic> toJson() => {
    ...
    "file": file,
    "modifiedDateTime": "${modifiedDateTime!.year.toString().padLeft(4, '0')}-${modifiedDateTime!.month.toString().padLeft(2, '0')}-${modifiedDateTime!.day.toString().padLeft(2, '0')}",
    "title": title,
    "size": size,
  };
}